...
@section("content")
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($language) Update Language @else Create New
                        Language @endisset</h5>
                ...
                <div class="panel-body">
                    @if(!isset($language))
                        {{ Form::open(['route' => ['languages.store'], 'files' => true, 'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($language, ['route' => ['languages.update', $language->id], 'files' => true, 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            ...
                            {!! Form::text('abbreviation', old('abbreviation'), ['id'=> 'abbreviation','class' => 'form-control', 'required', 'placeholder' => 'Abbreviation']) !!}
                            {!! $errors->first('abbreviation', '<label id="name-error" class="validation-error-label" for="abbreviation">:message</label>') !!}
                        </div>
                        <div class="col-md-4 col-lg-6 col-sm-6 col-xs-12 mt-15">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($language) Update @else
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List Languages</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                            {{--                            <li><a data-action="reload"></a></li>--}}
                ...
                <table class="table" id="LanguageDataTable">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Sr. No.</th>
