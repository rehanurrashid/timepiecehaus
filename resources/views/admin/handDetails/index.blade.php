...
@section("title", "Hand Detail Management")
...
@section("content")
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($handDetail) Update Hand Detail @else Create New
                        Hand Detail @endisset</h5>
                ...
                <div class="panel-body">
                    @if(!isset($handDetail))
                        {{ Form::open(['route' => ['handDetails.store'], 'files' => true, 'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($handDetail, ['route' => ['handDetails.update', $handDetail->id], 'files' => true, 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($handDetail) Update @else
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List Hand Details</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                            {{--                            <li><a data-action="reload"></a></li>--}}
                ...
                <table class="table" id="handDetailsDataTable">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Sr. No.</th>
...
@push("after-app-script")
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#handDetailsDataTable').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                ajax: "{{ route('handDetails.index') }}",
                columns: [
