...
@section("content")
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($productCategory) Update Product Category @else Create
                        New
                        Product Category @endisset</h5>
                ...
                <div class="panel-body">
                    @if(!isset($productCategory))
                        {{ Form::open(['route' => ['productCategories.store'], 'files' => true, 'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($productCategory, ['route' => ['productCategories.update', $productCategory->id], 'files' => true, 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                    ...
                    <div class="row mt-15">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($productCategory) Update @else
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List Product Categories</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                ...
                <table class="table" id="ProductCategoriesDataTable">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Sr. No.</th>
...
@push("after-app-script")
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#ProductCategoriesDataTable').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
