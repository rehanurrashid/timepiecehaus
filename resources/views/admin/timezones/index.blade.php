...
@section("content")
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($timezone) Update Timezone @else Create New
                        Timezone @endisset</h5>
                ...
                <div class="panel-body">
                    @if(!isset($timezone))
                        {{ Form::open(['route' => ['timezones.store'], 'files' => true, 'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($timezone, ['route' => ['timezones.update', $timezone->id], 'files' => true, 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            <label class="control-label" for="identifier">Identifier <span class="text-danger">*</span></label>
                            {!! Form::text('identifier', old('identifier'), ['id'=> 'identifier','class' => 'form-control', 'required', 'placeholder' => 'Identifier']) !!}
                            {!! $errors->first('identifier', '<label id="identifier-error" class="validation-error-label" for="identifier">:message</label>') !!}
                        </div>
                    </div>
                    <div class="row mt-15">
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($timezone) Update @else
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List Timezones</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                            {{--                            <li><a data-action="reload"></a></li>--}}
                ...
                <table class="table" id="timezonesDataTable">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Sr. No.</th>
...
@push("after-app-script")
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#timezonesDataTable').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                ajax: "{{ route('timezones.index') }}",
                columns: [
                    {data: 'id', name: 'timezones.id', visible: false},
