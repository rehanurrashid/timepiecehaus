...
@section("content")
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($color) Update Color @else Create New Color @endisset</h5>
                ...
                <div class="panel-body">
                    @if(!isset($color))
                        {{ Form::open(['route' => ['colors.store'], 'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($color, ['route' => ['colors.update', $color->id], 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($color) Update @else Create @endisset</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List Colors</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                            <li><a data-action="close"></a></li>
                ...
                <table class="table" id="colorsDataTable">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Sr. No.</th>
