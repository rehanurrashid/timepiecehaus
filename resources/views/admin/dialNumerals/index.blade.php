...
@section("title", "Dial Numeral Management")
...
@section("content")
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($dialNumeral) Update Dial Numeral @else Create New
                        Dial Numeral @endisset</h5>
                ...
                <div class="panel-body">
                    @if(!isset($dialNumeral))
                        {{ Form::open(['route' => ['dialNumerals.store'], 'files' => true, 'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($dialNumeral, ['route' => ['dialNumerals.update', $dialNumeral->id], 'files' => true, 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($dialNumeral) Update @else
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List Dial Numerals</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                            {{--                            <li><a data-action="reload"></a></li>--}}
                ...
                <table class="table" id="dialNumeralsDataTable">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Sr. No.</th>
...
@push("after-app-script")
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#dialNumeralsDataTable').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                ajax: "{{ route('dialNumerals.index') }}",
                columns: [
