        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($status) Update Status @else Create New Status @endisset</h5>
...
{{--                            <li><a data-action="reload"></a></li>--}}
                ...
                <div class="panel-body">
                    @if(!isset($status))
                        {{ Form::open(['route' => ['statuses.store'], 'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($status, ['route' => ['statuses.update', $status->id], 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            <label class="control-label" for="type">Type <span class="text-danger">*</span></label>
                            {!! Form::text('type', old('type'), ['id'=> 'type','class' => 'form-control', 'required']) !!}
                            {!! $errors->first('type', '<label id="type-error" class="validation-error-label" for="type">:message</label>') !!}
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    ...
                    <div class="row mt-15">
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            <label class="control-label" for="background_color">Background Color <span class="text-danger">*</span></label>
                            {!! Form::text('background_color', old('background_color'), ['id'=> 'background_color','class' => 'form-control', 'required']) !!}
                            {!! $errors->first('background_color', '<label id="background_color-error" class="validation-error-label" for="background_color">:message</label>') !!}
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($status) Update @else Create @endisset</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List Statuses</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
{{--                            <li><a data-action="reload"></a></li>--}}
                ...
                <table class="table" id="statusesDataTable">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Sr. No.</th>
