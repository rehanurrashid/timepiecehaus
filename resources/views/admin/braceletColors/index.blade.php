...
@section("title", "Bracelet Color Management")
...
@section("content")
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($braceletColor) Update Bracelet Color @else Create New
                        Bracelet Color @endisset</h5>
                ...
                <div class="panel-body">
                    @if(!isset($braceletColor))
                        {{ Form::open(['route' => ['braceletColors.store'], 'files' => true, 'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($braceletColor, ['route' => ['braceletColors.update', $braceletColor->id], 'files' => true, 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($braceletColor) Update @else
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List Bracelet Colors</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                ...
                <table class="table" id="braceletColorsDataTable">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Sr. No.</th>
...
@push("after-app-script")
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#braceletColorsDataTable').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                ajax: "{{ route('braceletColors.index') }}",
                columns: [
