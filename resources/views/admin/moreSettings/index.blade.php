...
@section("title", "More Setting Management")
...
@section("content")
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($moreSetting) Update More Setting @else Create New
                        More Setting @endisset</h5>
                ...
                <div class="panel-body">
                    @if(!isset($moreSetting))
                        {{ Form::open(['route' => ['moreSettings.store'], 'files' => true, 'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($moreSetting, ['route' => ['moreSettings.update', $moreSetting->id], 'files' => true, 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            <label class="control-label" for="type">Type <span class="text-danger">*</span></label>
                            @php $types = collect(['' => 'Select Type', 'Caliber' => 'Caliber', 'Case' => 'Case' ]) @endphp
                            {!! Form::select('type', $types, old('type'), ['id' => 'type', 'class' => 'select', 'required', 'data-placeholder' => "Select Type"]) !!}
                    ...
                    <div class="row mt-20">
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            ...
                            {!! $errors->first('status_id', '<label id="status_id-error" class="validation-error-label" for="status_id">:message</label>') !!}
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($moreSetting) Update @else
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List More Setting</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                ...
                <table class="table" id="MoreSettingDataTable">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Sr. No.</th>
...
@push("after-app-script")
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#MoreSettingDataTable').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                ajax: "{{ route('moreSettings.index') }}",
                columns: [
